...
#Which State has highest Wheat production from year 2005 to 2015?

Select State_Name,Round(Sum(Wheat_Production),1) as Max_Wheat from agriculture_dataset
where year>=2005 and year<=2015
group by State_Name
order by Max_wheat desc;